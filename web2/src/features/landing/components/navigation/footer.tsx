      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <a href="#" className="flex items-center gap-2 mb-4">
              <Heart className="h-6 w-6 text-white fill-green-200" />
              <span className="font-serif text-xl tracking-wide">Salsabil</span>
            </a>
            <p className="text-gray-400 text-sm">
              We are a nonprofit organization bringing clean water to people in need around the world.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li><a href="#" className="hover:text-white transition-colors">Financial Info</a></li>
          ...
          <div>
            ...
            <p className="text-gray-400 mb-2">123 Water Street</p>
            <p className="text-gray-400 mb-2">New York, NY 10001</p>
            <p className="text-gray-400 mb-2">contact@Salsabil.org</p>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between">
          <p className="text-gray-500 text-sm">
            © 2025 Salsabil. All rights reserved.
          </p>
